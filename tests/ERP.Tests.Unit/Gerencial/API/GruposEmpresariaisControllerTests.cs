...
namespace ERP.Tests.Unit.Gerencial.API
{
    public class GruposEmpresariaisControllerTests
    {
        ...
        public void GruposEmpresariaisController_GetAll_GruposEmpresariais_RetornarSucesso()
        {
            ...
            {
                new GrupoEmpresarialViewModel() { Id = Guid.Parse("f51745d6-d84a-49e6-a9bd-3d712c138b95"), Excluido = false, Codigo = "GE1", Descricao = "GE1", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel },
                new GrupoEmpresarialViewModel() { Id = Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), Excluido = true, Codigo = "GE2", Descricao = "GE2", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel }
            };
        ...
        public void GruposEmpresariaisController_GetById_GrupoEmpresarial_RetornarSucesso()
        {
            ...
            UsuarioViewModel usuarioViewModel = new UsuarioViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), Nome = "Foo", Sobrenome = "Ism", Email = "foo@programming.com" };
            GrupoEmpresarialViewModel expectedValue = new GrupoEmpresarialViewModel() { Id = Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), Excluido = true, Codigo = "GE2", Descricao = "GE2", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel };
        ...
        public void GruposEmpresariaisController_GetAll_Cnaes_RetornarSucesso()
        {
            ...
            Cnae cnae2 = Cnae.CnaeFactory.UpdateCnae(Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), "GE2", "GE2", null, dateTime, dateTime, Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), true);
            ...
            {
                new CnaeViewModel() { Id = Guid.Parse("f51745d6-d84a-49e6-a9bd-3d712c138b95"), Excluido = false, Codigo = "GE1", Descricao = "GE1", CnaePai = null, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel },
                new CnaeViewModel() { Id = Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), Excluido = true, Codigo = "GE2", Descricao = "GE2", CnaePai = null, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel }
            };
        ...
        public void GruposEmpresariaisController_GetById_Cnae_RetornarSucesso()
        {
            ...
            UsuarioViewModel usuarioViewModel = new UsuarioViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), Nome = "Foo", Sobrenome = "Ism", Email = "foo@programming.com" };
            CnaeViewModel expectedValue = new CnaeViewModel() { Id = Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), Excluido = true, Codigo = "GE2", Descricao = "GE2", CnaePai = null, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel };
        ...
        public void GruposEmpresariaisController_GetAll_Empresas_RetornarSucesso()
        {
            ...
            Usuario usuario = Usuario.UsuarioFactory.NewUsuario(Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), "Foo", "Ism", "foo@programming.com", dateTime, dateTime);
            Empresa empresa1 = Empresa.EmpresaFactory.NewEmpresa(Guid.Parse("f51745d6-d84a-49e6-a9bd-3d712c138b95"), "Empresa1", "Empresa1", "Empresa1", "empresa@gmail.com", "empresa.com.br", dateTime, new byte[0], "observacao", dateTime, dateTime, "01234567891234", TipoIdentificacao.CPF, Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde82a"), Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"));
            Empresa empresa2 = Empresa.EmpresaFactory.UpdateEmpresa(Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), "Empresa2", "Empresa2", "Empresa2", "empresa@gmail.com", "empresa.com.br", dateTime, new byte[0], "observacao", dateTime, dateTime, "01234567891234", TipoIdentificacao.CPF, Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde82a"), Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), true);
            grupoEmpresarial.AtribuirUsuario(usuario);
            ...
            UsuarioViewModel usuarioViewModel = new UsuarioViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), Nome = "Foo", Sobrenome = "Ism", Email = "foo@programming.com" };
            GrupoEmpresarialViewModel grupoEmpresarialViewModel = new GrupoEmpresarialViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde82a"), Excluido = false, Codigo = "GE1", Descricao = "GE1", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel};

            IEnumerable<EmpresaViewModel> expectedValue = new List<EmpresaViewModel>
            {
                new EmpresaViewModel() { Id = Guid.Parse("f51745d6-d84a-49e6-a9bd-3d712c138b95"), Excluido = false, Codigo = "Empresa1", Descricao = "Empresa1", NomeFantasia = "Empresa1", Email = "empresa@gmail.com", Site = "empresa.com.br", DataRegistro = dateTime, Logotipo = new byte[0], Observacao = "observacao", Documento = "01234567891234", TipoIdentificacao = TipoIdentificacao.CPF, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, GrupoEmpresarial = grupoEmpresarialViewModel, Usuario = usuarioViewModel },
                new EmpresaViewModel() { Id = Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), Excluido = true, Codigo = "Empresa2", Descricao = "Empresa2", NomeFantasia = "Empresa2", Email = "empresa@gmail.com", Site = "empresa.com.br", DataRegistro = dateTime, Logotipo = new byte[0], Observacao = "observacao", Documento = "01234567891234", TipoIdentificacao = TipoIdentificacao.CPF, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, GrupoEmpresarial = grupoEmpresarialViewModel, Usuario = usuarioViewModel }
            };
        ...
        public void GruposEmpresariaisController_GetById_Empresa_RetornarSucesso()
        {
            ...
            UsuarioViewModel usuarioViewModel = new UsuarioViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), Nome = "Foo", Sobrenome = "Ism", Email = "foo@programming.com" };
            GrupoEmpresarialViewModel grupoEmpresarialViewModel = new GrupoEmpresarialViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde82a"), Excluido = false, Codigo = "GE1", Descricao = "GE1", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel };
            EmpresaViewModel expectedValue = new EmpresaViewModel { Id = Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), Excluido = true, Codigo = "Empresa2", Descricao = "Empresa2", NomeFantasia = "Empresa2", Email = "empresa@gmail.com", Site = "empresa.com.br", DataRegistro = dateTime, Logotipo = new byte[0], Observacao = "observacao", Documento = "01234567891234", TipoIdentificacao = TipoIdentificacao.CPF, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, GrupoEmpresarial = grupoEmpresarialViewModel, Usuario = usuarioViewModel };
        ...
        public void GruposEmpresariaisController_GetAll_Estabelecimentos_RetornarSucesso()
        {
            ...
            GrupoEmpresarial grupoEmpresarial = GrupoEmpresarial.GrupoEmpresarialFactory.NewGrupoEmpresarial(Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde82a"), "GE1", "GE1", dateTime, dateTime, Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"));
            Usuario usuario = Usuario.UsuarioFactory.NewUsuario(Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), "Foo", "Ism", "foo@programming.com", dateTime, dateTime);
            Estabelecimento estabelecimento1 = Estabelecimento.EstabelecimentoFactory.NewEstabelecimento(Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde70a"), "Estabelecimento1", "Estabelecimento1", "Estabelecimento1", "01234567890123456789", "01234567890123456789", "estabelecimento@gmail.com", "estabelecimento.com.br", dateTime, new byte[0], true, "observacao", dateTime, dateTime, "01234567890123", TipoIdentificacao.CPF, Guid.Parse("f51745d6-d84a-49e6-a9bd-3d712c138b95"), Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde80a"), Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"));
            Estabelecimento estabelecimento2 = Estabelecimento.EstabelecimentoFactory.UpdateEstabelecimento(Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde71a"), "Estabelecimento2", "Estabelecimento2", "Estabelecimento2", "01234567890123456789", "01234567890123456789", "estabelecimento@gmail.com", "estabelecimento.com.br", dateTime, new byte[0], true, "observacao", dateTime, dateTime, "01234567890123", TipoIdentificacao.CPF, Guid.Parse("f51745d6-d84a-49e6-a9bd-3d712c138b95"), Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde80a"), Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), true);
            grupoEmpresarial.AtribuirUsuario(usuario);
            cnae.AtribuirUsuario(usuario);
            empresa.AtribuirGrupoEmpresarial(grupoEmpresarial);
            empresa.AtribuirUsuario(usuario);
            ...
            UsuarioViewModel usuarioViewModel = new UsuarioViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde81a"), Nome = "Foo", Sobrenome = "Ism", Email = "foo@programming.com" };
            GrupoEmpresarialViewModel grupoEmpresarialViewModel = new GrupoEmpresarialViewModel { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde82a"), Excluido = false, Codigo = "GE1", Descricao = "GE1", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel };
            CnaeViewModel cnaeViewModel = new CnaeViewModel() { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde80a"), Excluido = false, Codigo = "Cnae1", Descricao = "Cnae1", CnaePai = null, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel };
            ...
            {
                new EstabelecimentoViewModel() { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde70a"), Excluido = false, Codigo = "Estabelecimento1", Descricao = "Estabelecimento1", NomeFantasia = "Estabelecimento1", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel, Cnae = cnaeViewModel, Empresa = empresaViewModel, TipoIdentificacao = TipoIdentificacao.CPF, DataRegistro = dateTime, Documento = "01234567890123", Observacao = "observacao", Site = "estabelecimento.com.br", Email = "estabelecimento@gmail.com", Logotipo = new byte[0], InscricaoMunicipal = "01234567890123456789", InscricaoEstadual = "01234567890123456789", Matriz = true },
                new EstabelecimentoViewModel() { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde71a"), Excluido = true, Codigo = "Estabelecimento2", Descricao = "Estabelecimento2", NomeFantasia = "Estabelecimento2", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel, Cnae = cnaeViewModel, Empresa = empresaViewModel, TipoIdentificacao = TipoIdentificacao.CPF, DataRegistro = dateTime, Documento = "01234567890123", Observacao = "observacao", Site = "estabelecimento.com.br", Email = "estabelecimento@gmail.com", Logotipo = new byte[0], InscricaoMunicipal = "01234567890123456789", InscricaoEstadual = "01234567890123456789", Matriz = true }
            };
        ...
        public void GruposEmpresariaisController_GetById_Estabelecimento_RetornarSucesso()
        {
            ...
            CnaeViewModel cnaeViewModel = new CnaeViewModel() { Id = Guid.Parse("e7261a1f-18e8-4de6-9b4b-a659a8fde80a"), Excluido = false, Codigo = "Cnae1", Descricao = "Cnae1", CnaePai = null, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel };
            EmpresaViewModel empresaViewModel = new EmpresaViewModel() { Id = Guid.Parse("f51745d6-d84a-49e6-a9bd-3d712c138b95"), Excluido = false, Codigo = "Empresa1", Descricao = "Empresa1", NomeFantasia = "Empresa1", Email = "empresa@gmail.com", Site = "empresa.com.br", DataRegistro = dateTime, Logotipo = new byte[0], Observacao = "observacao", Documento = "01234567891234", TipoIdentificacao = TipoIdentificacao.CPF, DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, GrupoEmpresarial = grupoEmpresarialViewModel, Usuario = usuarioViewModel };
            EstabelecimentoViewModel expectedValue = new EstabelecimentoViewModel() { Id = Guid.Parse("4131468b-adb9-4805-b1ea-1ae7d5e38cf4"), Excluido = true, Codigo = "Estabelecimento1", Descricao = "Estabelecimento1", NomeFantasia = "Estabelecimento1", DataCadastro = dateTime, DataUltimaAtualizacao = dateTime, Usuario = usuarioViewModel, Cnae = cnaeViewModel, Empresa = empresaViewModel, TipoIdentificacao = TipoIdentificacao.CPF, DataRegistro = dateTime, Documento = "01234567890123", Observacao = "observacao", Site = "estabelecimento.com.br", Email = "estabelecimento@gmail.com", Logotipo = new byte[0], InscricaoMunicipal = "01234567890123456789", InscricaoEstadual = "01234567890123456789", Matriz = true };
