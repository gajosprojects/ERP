...
namespace ERP.Tests.Unit.Gerencial.Events
{
    public class GrupoEmpresarialEventHandlerTests
    {
        ...
        {
            SavedEmpresaEvent notification = new SavedEmpresaEvent(Guid.NewGuid(), true, Guid.NewGuid(), DateTime.Now, DateTime.Now, "Empresa1", "Empresa1", "Empresa1", "empresa@gmail.com", "empresa.com.br", DateTime.Now, null, "", "", TipoIdentificacao.CPF, Guid.NewGuid());
            Assert.Equal(_grupoEmpresarialEventHandler.Handle(notification, new CancellationToken()), Task.CompletedTask);
        }
        ...
        {
            UpdatedEmpresaEvent notification = new UpdatedEmpresaEvent(Guid.NewGuid(), true, Guid.NewGuid(), DateTime.Now, DateTime.Now, "Empresa1", "Empresa1", "Empresa1", "empresa@gmail.com", "empresa.com.br", DateTime.Now, null, "", "", TipoIdentificacao.CPF, Guid.NewGuid());
            Assert.Equal(_grupoEmpresarialEventHandler.Handle(notification, new CancellationToken()), Task.CompletedTask);
        }
